...
var validator = (function($){
    ...
    */
    message = {
        ...
        checked         : 'Трябва да се отбележи',
        empty           : 'Въведете информация',
        min             : 'Стойноста е прекалено малка',
        max             : 'Стойноста е прекалено голяма',
        number_min      : 'Твърде малко число',
        number_max      : 'Твърде голямо число',
        url             : 'грешен уеб адрес',
        number          : 'Не е число',
        email           : 'Невалиден имейл',
        email_repeat    : 'Имайла не съвпада',
        password_repeat : 'Паролата не съвпада',
        repeat          : 'Няма съвпадение',
        complete        : 'Данните не са пълни',
        select          : 'Моля изберете опция'
    };
