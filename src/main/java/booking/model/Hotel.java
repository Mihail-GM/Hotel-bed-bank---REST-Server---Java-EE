...
public class Hotel {
    ...
    public Hotel(String name, String description, String address, int rating, Category category, boolean status, String leadingPrice) {    	
    	this.name = name;
	...
	public String getLeadingPrice() {
		return leadingPrice;
	}

	public void setLeadingPrice(String leadingPrice) {
		this.leadingPrice = leadingPrice;
	}
}
